  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white  dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780 sm:w-780">
            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className="ml-2 p-1 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 text-xs">
                    23%
                  </span>
                </p>
